...
training_args = TrainingArguments(
    #核心输出设置
    output_dir="../models/full_ft",     # 模型和日志保存的根目录
...
# 10. 保存最佳模型和分词器
print("\n保存最佳模型...")
trainer.save_model("../models/full_ft/best_model")
tokenizer.save_pretrained("../models/full_ft/best_model")

print("\n训练完成！最佳模型已保存至 ../models/full_ft/best_model")